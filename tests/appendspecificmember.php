...
/** @var \Zeevin\Libiocm\Dm\SpecificMemberAppendClient $app1 */
$app1 = $app['dm.append.devgroup.specific.member'];
$accessAppId = 'xxxx';
//print_r($request->serialize());exit;
/** @var Zeevin\Libiocm\Dm\ResponseAttribute\Devices\SpecificMemberAppend\Response $ret */
